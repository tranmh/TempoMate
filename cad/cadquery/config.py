...
fase_oben = 1  # 45-Grad-Fase an Wippe-Oberkanten (Freiraum beim Kippen)
...
lehne_hoehe = 22        # Rueckenlehne hinter dem Schlitz
...
lehne_zapfen_tiefe = 10     # Gesamtlaenge Zapfen
